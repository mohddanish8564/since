...
<head>
  ...
  <title><?php echo $title?></title>
	 ...
	 <link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/js/exporttable/tableexport.css">
		 <link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/js/exporttable/examples.css">
				...
				<header id="header">
					...
					<div class="pull-right">
						...
						<div id="hide-menu" class="btn-header pull-right">
							<span> <a href="javascript:void(0);" title="Collapse Menu" data-action="toggleMenu" class="autoclick"><i class="fa fa-reorder"></i></a> </span>
						</div>
						<!-- end collapse menu -->
						...
						<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
							<li class="">
								...
								<ul class="dropdown-menu pull-right">
									...
									<li class="divider"></li>
									<li>
										<a href="<?php echo base_url().'admin-logout' ?>" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i class="fa fa-sign-out fa-lg"></i> <strong><u>L</u>ogout</strong></a>
									</li>
								</ul>
							</li>
						</ul>
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/admin-logout" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
