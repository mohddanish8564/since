...
/* Indicator 2 */
		...
		if(	$selectedquarter!='All'){
		     ...
		     $BeforeQuarter_Er1Ind2="(SELECT $maincolumn  FROM `xls_import_beneficiary_trainings` as benetrain inner join xls_import_beneficiaries as bene on bene.beneficiary_id=benetrain.beneficiary_id where benetrain.Is_Training_completed='true' $whereQuarter)";
			
					  	$BtwQuarter_Er1Ind2="(SELECT $maincolumn  FROM `xls_import_beneficiary_trainings` as benetrain inner join xls_import_beneficiaries as bene on bene.beneficiary_id=benetrain.beneficiary_id where benetrain.Is_Training_completed='true' $whereBetweenQuarter)";
						
					  	$Er1Sqlnd2="select $BeforeQuarter_Er1Ind2 as A ,$BtwQuarter_Er1Ind2 as B from xls_import_beneficiary_trainings as benet where benet.Is_Training_completed='true' group by benet.`Region`";
     ...
     //   echo $Er1Sqlnd2;
					...
					//	print_r($BeforeQuarter_SpecObjInd2);
					 ...
					 <td><?php echo $A ?></td>
								...
								<td><?php echo $B ?></td>
											...
											$whereQuarter="Year(Agr_Date)<='$selectedyear'";
											$whereBetweenQuarter=$whereQuarter;
										}
				  ...
				  $BeforeQuarter_Er1Ind3="(select $maincolumn as A from xls_import_pp where 1=1  $whereQuarter  group by `Region`)";
      $BtwQuarter_Er1Ind3="(select $maincolumn as A from xls_import_pp where 1=1  $whereBetweenQuarter  group by `Region`)";
					
					  	$Er1Sqlnd3="select $BeforeQuarter_Er1Ind2 as A ,$BtwQuarter_Er1Ind2 as B from xls_import_beneficiary_trainings as benet where benet.Is_Training_completed='true' group by benet.`Region`";
				...
				$Er1_Er1Sqlnd4= $this->Allfunction->runQueryGet($Er1Sqlnd3);
