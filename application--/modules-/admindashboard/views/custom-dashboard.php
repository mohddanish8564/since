...
Highcharts.chart('container', {
    ...
    title: {
        text: 'No. of unemployed and/or inactive target beneficiaries who are employed through job opportunities created by SINCE '
    },
    subtitle: {
        text: 'Lot 1 Addis Ababa Quarter 1 2019'
    },
    xAxis: {
        categories: ['Youth', 'Returnee', 'Women 15-35', 'Women Beyond 36'],
        title: {
            text: null
        }
    },
