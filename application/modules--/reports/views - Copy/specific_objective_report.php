...
<section id="widget-grid" class="">
   ...
   <!--Indicator 1 -->			
				...
				$indicatorSex_male="(SELECT count(distinct jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' and jp.`Region` like '%$regionName%' and bene.sex='$sex' $whereQuarter)";
				
				
				$sex='Female';
				$indicatorSex_female="(SELECT count(distinct jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' and jp.`Region` like '%$regionName%' and bene.sex='$sex' $whereQuarter)";
...
// die;
	$indicator1_valuechain= $this->Allfunction->runQueryGet($valuechainSql);
		...
		<?php 
				...
				$indicator1_youth="(SELECT count(distinct jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' and jp.`Region` like '%$regionName%' and bene.`target_group`='$wherecolumn' $whereQuarter)";
				
				
			  $wherecolumn='Refugees';				
		   $indicator1_women="(SELECT count(distinct jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' and jp.`Region` like '%$regionName%' and bene.`target_group`='$wherecolumn' $whereQuarter)";
				
				
				 $wherecolumn='Returnee';				
		   $indicator1_returnee="(SELECT count(distinct jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' and jp.`Region` like '%$regionName%' and bene.`target_group`='$wherecolumn' $whereQuarter)";
		   ...
		   $indicator1_QuarterSql="SELECT count(distinct jp.`beneficiary_id`) as quarterwisecount  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' and jp.`Region` like '%$regionName%' $whereBetweenQuarter";
