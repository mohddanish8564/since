...
// die;
			...
			?>
						...
						//	$regionwhere='';
								...
								$BeforeQuarter_speficInd2="(SELECT count(distinct jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' $regionwhere  $whereQuarter $after3months )";

			

					  	$BtwQuarter_speficInd2="(SELECT count(distinct jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' $regionwhere  $whereBetweenQuarter $after3months )";
