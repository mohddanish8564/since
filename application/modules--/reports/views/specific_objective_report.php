...
$totalvaluechain5=0;		
				...
				$indicatorSex_male="(SELECT count(jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' and jp.`Region` like '%$regionName%' and bene.region like '%$regionName%' and bene.sex='$sex' $whereQuarter $after3months )";
				
			
				$sex='Female';
				$indicatorSex_female="(SELECT count(jp.`beneficiary_id`)  FROM `xls_import_job_placement` as jp inner join xls_import_beneficiaries as bene on bene.beneficiary_id=jp.beneficiary_id where jp.placement_type='Employment' and jp.`Region` like '%$regionName%' and bene.region like '%$regionName%' and bene.sex='$sex' $after3months $whereQuarter $after3months )";
